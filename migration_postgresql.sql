-- DDL para migração do Supabase para PostgreSQL
-- Banco: cefetTinder
-- Schema: public
...
COMMENT ON TABLE public.matches IS 'Tabela de matches e likes entre usuários';
...
COMMENT ON COLUMN public.matches.matched_at IS 'Timestamp de quando ocorreu o match (quando ambos deram like)';